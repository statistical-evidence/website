---
title: "Bootstrap R tutorial : Parametric vs Nonparametric Bootstrap"
...
<img alt="bootstrap parametric nonparametric r" src="/images/bootcover.png" />
...
```{r fig.cap="Distribution of sample means",fig.align="center",out.width="50%"}
require(ggplot2)
...
```{r fig.cap="Distribution of sample means (proper histogram)",fig.align="center",out.width="50%"}
...
```{r echo=FALSE, fig.cap="Parametric vs nonparametric bootstrap",fig.align="center"}
...
```{r fig.cap="Bootstrap sampling distribution of sample mean",fig.align="center",out.width="50%"}
plot(B)
```

Or, one can use `ggplot` to get the same figure

```{r fig.cap="Bootstrap sampling distribution of sample mean  (ggplot2)",fig.align="center",out.width="50%" }
...
```{r fig.cap="Distribution of observed sample birthweights",fig.align="center",out.width="50%"}
