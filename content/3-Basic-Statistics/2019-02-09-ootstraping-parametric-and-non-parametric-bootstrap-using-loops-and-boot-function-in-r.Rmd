---
title: ' Bootstrapping: Parametric and Non-parametric bootstrap using loops and boot
  function in R'
author: Chetan Prajapati
date: '2019-02-09'
slug: bootstrapping-parametric-and-non-parametric-bootstrap-using-loops-and-boot-function-in-r
categories:
  - bootstrap
tags:
  - parametric
...
knitr::opts_chunk$set(echo = TRUE,fig.height=3.5, fig.width=3.5, message=FALSE, warning=FALSE)
```
...
<img alt="bootstapping parametric non-parametric bootstrap loop boot" src="/images/bootstrap.png" height="500px" width="1100px" />
